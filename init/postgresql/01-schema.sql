...
-- -------------------------------------------------------------
-- Tabla: alumnos
-- SERIAL: sintaxis propia de PostgreSQL para auto-incremento
-- (MariaDB usa AUTO_INCREMENT; Firebird usa GENERATED BY DEFAULT AS IDENTITY)
-- -------------------------------------------------------------
...
-- -------------------------------------------------------------
-- Tabla: notas
-- NUMERIC: equivalente a DECIMAL en PostgreSQL
-- -------------------------------------------------------------
